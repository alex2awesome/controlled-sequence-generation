...
katie compute run \
        ...
        $worker_args \
        --python-module editing.run_stage_two \
        ...
        --use_heuristic_masks \
        --finetuned_editor_lm_path "./t5-trained-editor-noun-heuristics__l1-norm-grad" \
        --edit_output_file 'aspangher/controlled-sequence-gen/experiments/first-pass-contrastive-edits.csv'
