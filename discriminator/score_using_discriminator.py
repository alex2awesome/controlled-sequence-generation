...
from discriminator.utils_general import get_device
from util.utils_general import reformat_model_path, _get_attention_mask
...
import logging
from util.utils_model_loader import ModelLoader
...
if __name__=="__main__":
    ...
    if config.do_doc_pred:
        ...
        df = df.loc[lambda df: df.notnull().all(axis=1)]#.head(10000)
